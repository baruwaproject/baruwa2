...
class TopSpammersCommand(BaseCommand):
    "Top Spammers command"
    ...
    BaseCommand.parser.add_option('-s', '--spam-score-threshold',
        help='Count messages with spam scores equal to or greater than',
        dest='spamscore',
        type='float',
        default=20,)
    ...
    summary = 'Generates a list of top spammers and emails it'
    group_name = 'baruwa'
